// Tony Le
// The purpose of this file as part of the whole application is to implement
// a stack of objects that will be used with the ImageEnhancerWithUndoAndRedoV2 file in
// order to be able to undo and redo a filter setting applied to an image of UW.
...
public class ImageStack {
	...
	public ImageStack() { // other parameters?
		check = 0;
		lastOne = "";
	...
	// This method returns the top element of the stack, removing it from
	// the stack. 
	...
	// This method returns true if the last push, pop, or clear
	// operation was a pop and false otherwise. If neither pop, push
	// nor clear has yet been executed, false is returned.
